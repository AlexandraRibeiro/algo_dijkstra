...
/*   Updated: 2016/04/18 20:20:34 by aribeiro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
** extentions to my standard libft, including :
**			get_next_line
**			ft_printf
**			addin functions malloc with exit
**			new tools functions
*/
...
char				*ft_lltoa_base(MY_UIMAX uiconv, t_spec *sp,
															unsigned int base);
...
/*
** -- LIBFT extensions with exit for malloc's error -----------------
*/
